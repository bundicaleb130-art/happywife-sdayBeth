...
/* ============================================================
   ...
   ============================================================ */
const MEMORIES = [
  { title: 'The First Hello', date: 'Feb 14, 2024', caption: "I didn't know a simple hello could change my whole life." },
  { title: 'First Coffee Date', date: 'Feb 22, 2024', caption: "I was so nervous I forgot how to hold my cup." },
  { title: 'You Laughed At My Joke', date: 'Mar 3, 2024', caption: "That's when I knew I was in trouble." },
  { title: 'Rainy Walk Home', date: 'Mar 19, 2024', caption: "Getting soaked never felt so warm." },
  { title: 'Our First Movie Night', date: 'Apr 2, 2024', caption: "I don't remember the movie. I remember your head on my shoulder." },
  { title: 'The Long Phone Call', date: 'Apr 20, 2024', caption: "We talked until the sun came up and it still wasn't enough." },
  { title: 'Meeting Your Friends', date: 'May 8, 2024', caption: "I wanted them to like me almost as much as I like you." },
  { title: 'First Trip Together', date: 'Jun 1, 2024', caption: "New places feel better when you're the one next to me." },
  { title: 'You Called Me Yours', date: 'Jun 14, 2024', caption: "Three words that made everything official and everything better." },
  { title: 'Cooking Disaster', date: 'Jul 9, 2024', caption: "We burned dinner and ordered pizza and I still call it a favorite night." },
  { title: 'Your Birthday', date: 'Aug 3, 2024', caption: "Watching you light up is my favorite kind of celebration." },
  { title: 'The Long Distance Week', date: 'Sep 12, 2024', caption: "Missing you taught me how much space you take up in my life." },
  { title: 'Beach Day', date: 'Oct 5, 2024', caption: "Sunburnt, salty, and completely happy." },
  { title: 'First Fight, First Fix', date: 'Oct 28, 2024', caption: "We learned how to come back to each other." },
  { title: 'Study Nights', date: 'Nov 15, 2024', caption: "You made deadlines feel less lonely." },
  { title: 'Holiday Lights', date: 'Dec 20, 2024', caption: "You looked like every good thing about winter." },
  { title: 'New Year, Same Us', date: 'Jan 1, 2025', caption: "I only had one resolution: more of this." },
  { title: 'Lazy Sunday', date: 'Feb 9, 2025', caption: "Doing nothing with you still feels like everything." },
  { title: 'One Year Of Us', date: 'Feb 14, 2025', caption: "A whole year, and I'd still pick you first, every time." },
  { title: 'Right Now', date: 'Today', caption: "Still writing our story, one favorite day at a time." },
];
